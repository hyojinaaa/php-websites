...
class EditCommentController extends PageController {
	...
	public function __construct($dbc) {
		...
		// Oops, we everrode the parent constuctor 
		// make sure we run if! IT'S important!
		parent::__construct();
 	...
 	private function processComment() {
 		...
 		// If all is good, update the datebase
 		if( $totalErrors == 0 ) {
 			...
 			// Redirect user back to the post that has their comment
